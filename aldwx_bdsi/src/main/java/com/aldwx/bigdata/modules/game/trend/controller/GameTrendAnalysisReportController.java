package com.aldwx.bigdata.modules.game.trend.controller;

import com.aldwx.bigdata.common.base.BaseController;
import com.aldwx.bigdata.common.util.DateUtil;
import com.aldwx.bigdata.modules.game.trend.service.StatGameTrendService;
import com.aldwx.bigdata.modules.game.trend.vo.JsonResult;
...
@RequestMapping(value = "trend/report/game")
public class GameTrendAnalysisReportController extends BaseController {
    private static final Logger LOG = LoggerFactory.getLogger(GameTrendAnalysisReportController.class);
//    @Autowired
//    private AldstatTrendAnalysisService aldstatTrendAnalysisService;

    @Autowired
    private StatGameTrendService statTrendService;
