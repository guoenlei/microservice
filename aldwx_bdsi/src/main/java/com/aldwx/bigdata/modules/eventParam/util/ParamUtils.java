package com.aldwx.bigdata.modules.eventParam.util;
...
public class ParamUtils {
     ...
     * @return
     */
    public static Map<String, String> check(AldEventParamVo vo) {
     ...
     * @return
     */
    public static AldEventParamVo format(AldEventParamVo vo) {
        String date = vo.getDate();
