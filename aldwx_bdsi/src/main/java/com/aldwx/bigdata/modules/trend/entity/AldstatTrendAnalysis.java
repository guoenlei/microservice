package com.aldwx.bigdata.modules.trend.entity;
 ...
 * @author 
 */
public class AldstatTrendAnalysis implements Serializable {
    /**
     * 自增id
     */
    private Long id;
    ...
    private Integer total_visitor_count;
    ...
    public Integer getTotal_visitor_count() {
        return total_visitor_count;
    }

    public void setTotal_visitor_count(Integer total_visitor_count) {
        this.total_visitor_count = total_visitor_count;
    }
}