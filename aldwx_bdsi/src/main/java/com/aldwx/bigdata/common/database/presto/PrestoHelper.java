package com.aldwx.bigdata.common.database.presto;
...
@Configuration
//@MapperScan(basePackages = PrestoHelper.PACKAGE, sqlSessionFactoryRef = "prestoSqlSessionFactory")
...
//        dataSource.setPassword(password);
    ...
    public SqlSessionFactory prestoSqlSessionFactory(@Qualifier("prestoDataSource") DataSource prestoDataSource)
        ...
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources(PrestoHelper.MAPPER_LOCATION));
