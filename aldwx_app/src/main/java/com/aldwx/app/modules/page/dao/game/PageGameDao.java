package com.aldwx.app.modules.page.dao.game;
 ...
 */
@Mapper
public interface PageGameDao extends BaseDao {
    ...
    @Results(
            value = {
                    ...
                    @Result(property = "abortPageCount", column = "abort_page_count"),
                    @Result(property = "entryPageCount", column = "abort_ratio"),
                    @Result(property = "shareCount", column = "share_count"),
                    @Result(property = "openCount", column = "open_count"),
                    @Result(property = "avgStayTime", column = "avg_stay_time"),
            })
    @Select("select page_path, page_count, visitor_count, downstream_count, " +
            "total_stay_time, abort_page_count, abort_ratio, " +
            "share_count, open_count, avg_stay_time " +
            "from ${tableName} " +
            "where 1=1 " +
            "and day=#{dateTime} " +
