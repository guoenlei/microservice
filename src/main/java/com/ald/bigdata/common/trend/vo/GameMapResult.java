...
public class GameMapResult {
    ...
    public static List<Map<String, String>> GetTableMap(List list, TrendQueryVo vo, String a){
        ...
        if (vo.getDataType().equals("1")) {
            listRes = GameMapResult.getEmptyHour(vo,a);
        ...
        if (vo.getDataType().equals("2")) {
            listRes = GameMapResult.getEmptyDay(vo, a);
            if (list != null && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    Map mapresult = (Map) list.get(i);
                    Map map = new LinkedHashMap();
        ...
        if (vo.getDataType().equals("3")){
            listRes= GameMapResult.getEmptyWeek(vo,a);
            if (list != null && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    Map mapresult = (Map) list.get(i);
                    Map map = new LinkedHashMap();
        ...
        if (vo.getDataType().equals("4")){
            listRes= GameMapResult.getEmptyMonth(vo,a);
            if (list != null && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    Map mapresult = (Map) list.get(i);
                    Map map = new LinkedHashMap();
    ...
    public static Map GetChartMap(List list, TrendQueryVo vo, String a){
        ...
        List tema= GameMapResult.getMapEmpty(vo,a);
        List temb= GameMapResult.getMapEmpty(vo,a);
        List temd= GameMapResult.getMapEmpty(vo,a);
        List teme= GameMapResult.getMapEmpty(vo,a);
