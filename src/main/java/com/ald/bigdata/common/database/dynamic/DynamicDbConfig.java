...
//    private static String MAPPER_PATH = "mybatis/mapper/**.xml";
    ...
    static final String PACKAGE = "com.ald.bigdata.modules.ad.dao.master,com.ald.bigdata.modules.ad.dao.cluster,com.ald.bigdata.modules.ad.dao.presto,";
    static final String MAPPER_LOCATION = "classpath*:mapper/master/*.xml,classpath*:mapper/report/*.xml,";
