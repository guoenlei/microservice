package com.ald.bigdata.common.page;
...
public class PageUtil extends PageInfo {
    ...
    public static int reStartRow(int currentPage, int total) {
        int startRow = (int)(startRow(currentPage, total)/10);
    ...
    public static int reEndRow(int currentPage, int total) {
        return (int)(endRow(currentPage, total)*10);
    }




    private Page<?> startPage(BaseVo vo) {
