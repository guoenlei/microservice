...
public class WXGameTrendAnalysisReportController {
    private static final Logger LOG = LoggerFactory.getLogger(WXGameTrendAnalysisReportController.class);
...
//        JdbcTemplate jdbcTemplate = (JdbcTemplate) applicationContext.getBean("wxGameJdbcTemplate");
