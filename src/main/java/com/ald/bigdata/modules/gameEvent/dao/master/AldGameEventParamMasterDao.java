package com.ald.bigdata.modules.gameEvent.dao.master;
...
@Mapper
public interface AldGameEventParamMasterDao extends BaseDao<AldGameEventParamEntity, AldGameEventParamVo> {
