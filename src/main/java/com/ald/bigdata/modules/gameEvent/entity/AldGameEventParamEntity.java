package com.ald.bigdata.modules.gameEvent.entity;


import com.ald.bigdata.common.base.BaseEntity;

public class AldGameEventParamEntity extends BaseEntity {
    ...
    public AldGameEventParamEntity() {}


    public AldGameEventParamEntity(String appKey, String day, String evId, String eventKey, String evParasName,
