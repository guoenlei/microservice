...
/**
 * QQ小游戏趋势分析模块controller
 */
@Controller
@EnableAutoConfiguration
@RequestMapping(value = "qq/game/trend")
public class QQGameTrendAnalysisReportController {
    private static final Logger LOG = LoggerFactory.getLogger(QQGameTrendAnalysisReportController.class);
...
//        JdbcTemplate jdbcTemplate = (JdbcTemplate) applicationContext.getBean("qqGameJdbcTemplate");
